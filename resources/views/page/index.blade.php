        ...
        <tr>
          ...
          <td>
            <div class="input-group-btn">
              <a href="{{ route('page.edit', $page->id) }}" class="btn btn-warning" style="margin-right:5px">Edit</a>
              <a href="{{ route('page.delete', $page->id) }}" class="btn btn-danger"
                 onclick="return confirm('Are you sure to delete this page?');" style="margin-right:5px">
                Delete
              </a>
			  <a href="{{ $page->url }}" class="btn btn-primary" target="_blank">Watch the trailer</a>
            </div>
          </td>
        </tr>
      @endforeach
